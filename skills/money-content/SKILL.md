...
7. **Video scripts** — YouTube/TikTok content
...
For each content piece, follow this process:
...
- Run content through E-E-A-T checklist (Experience, Expertise, Authority, Trust)
- Check for AI-sounding language and humanize
...
- **Data-informed** — Use keyword data and competitor analysis
